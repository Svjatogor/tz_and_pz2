...
Утверждаю\\
\vspace{11pt}\VSTUHeadOfDepartmentPost\\
\vspace{3.5pt}\VSTUUnderlinedField{2cm}{подпись}{\vphantom{\VSTUHeadOfDepartmentDegreeAndName}}\hfill\VSTUUnderlinedField{6.6cm}{инициалы, фамилия}{\VSTUHeadOfDepartmentDegreeAndName}\\

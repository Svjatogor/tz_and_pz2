...
\begin{minipage}[c]{18.5em}
УТВЕРЖДАЮ\\
\VSTUHeadOfDepartmentPost\\
\VSTUUnderlinedField{2cm}{подпись}{\vphantom{\VSTUHeadOfDepartmentDegreeAndName}}\hfill\VSTUUnderlinedField{7cm}{инициалы, фамилия}{\VSTUHeadOfDepartmentDegreeAndName}\\
